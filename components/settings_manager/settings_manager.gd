...
const MODE_FULLSCREEN = DisplayServer.WINDOW_MODE_EXCLUSIVE_FULLSCREEN
const MODE_WINDOWED = DisplayServer.WINDOW_MODE_WINDOWED
...
func set_fullscreen(fullscreen: bool):
	var next_mode: DisplayServer.WindowMode = MODE_FULLSCREEN if fullscreen else MODE_WINDOWED
...
func is_fullscreen() -> bool:
	return DisplayServer.window_get_mode() == MODE_FULLSCREEN

func is_windowed() -> bool:
	return DisplayServer.window_get_mode() == MODE_WINDOWED
